...
# --- SHOT 1 영상 (84 cr) ---
higgsfield generate create lumina seedance_2_5 \
  --start-image frames/01.png \
  --prompt "Slow push in toward HIJA at the rail. The assistant steps forward once. Clothes on the rail sway slightly." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 2 영상 (84 cr) ---
higgsfield generate create lumina seedance_2_5 \
  --start-image frames/02.png \
  --prompt "Static shot. HIJA lifts the jacket against her shoulders. The assistant extends her arm to point." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 3 영상 (84 cr) ---
higgsfield generate create lumina seedance_2_5 \
  --start-image frames/03.png \
  --prompt "Static shot. HIJA raises one arm and the oversized sleeve flops. The assistant turns her head." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 4 영상 (84 cr) ---
higgsfield generate create lumina seedance_2_5 \
  --start-image frames/04.png \
  --prompt "Static shot. MADRE turns the price tag once. HIJA's shoulders drop slightly." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 5 영상 (84 cr) ---
higgsfield generate create lumina seedance_2_5 \
  --start-image frames/05.png \
  --prompt "Static shot. MADRE turns her head to the assistant. The assistant raises three fingers." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 6 영상 (84 cr) ---
higgsfield generate create lumina seedance_2_5 \
  --start-image frames/06.png \
  --prompt "Slight push in. HIJA hugs the jacket tighter and nods once." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 7 영상 (84 cr) ---
higgsfield generate create lumina seedance_2_5 \
  --start-image frames/07.png \
  --prompt "Static shot. MADRE extends the card. The assistant reaches for the terminal." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 8 영상 (84 cr) ---
higgsfield generate create lumina seedance_2_5 \
  --start-image frames/08.png \
  --prompt "Static shot. MADRE turns her head back. PADRE does not move at all. The hanger spins." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait
