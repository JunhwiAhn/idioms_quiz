...
higgsfield generate create kling3_0_turbo \
  ...
  --prompt "Slow push in toward the doors. The car sways gently once. HIJA lifts her head. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 2 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/02.png \
  --prompt "Static shot. HIJO pushes twice and does not move. MADRE taps her throat once. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 3 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/03.png \
  --prompt "Static shot. MADRE raises her flat hand and her mouth opens clearly. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 4 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/04.png \
  --prompt "Static shot. MADRE gives one small nod. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 5 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/05.png \
  --prompt "Slight push in. HIJO cups his hands and his mouth opens wide. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 6 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/06.png \
  --prompt "Slight push in. The commuter turns sideways and lifts his backpack. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 7 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/07.png \
  --prompt "Static shot. The train begins to slide left. PADRE does not move at all. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 8 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/08.png \
  --prompt "Static shot. The metro door illustration shifts almost imperceptibly. Nothing else moves." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait
