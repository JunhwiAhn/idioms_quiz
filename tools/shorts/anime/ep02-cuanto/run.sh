...
higgsfield generate create kling3_0_turbo \
  ...
  --prompt "Slow push in toward the table. HIJO opens the fan. The canvas cover ripples. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 2 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/02.png \
  --prompt "Static shot. HIJO lifts the fan higher. MADRE nods once toward the vendor. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 3 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/03.png \
  --prompt "Static shot. MADRE leans down and her mouth opens on the words. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 4 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/04.png \
  --prompt "Static shot. MADRE points off-frame once. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 5 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/05.png \
  --prompt "Slight push in. HIJO points at the fan and his mouth opens wide. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 6 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/06.png \
  --prompt "Slight push in. The vendor holds up three fingers and waves once. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 7 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/07.png \
  --prompt "Static shot. MADRE opens her purse. PADRE does not move at all. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 8 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/08.png \
  --prompt "Static shot. The price tag sways almost imperceptibly. Nothing else moves." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait
