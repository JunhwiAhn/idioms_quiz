...
higgsfield generate create kling3_0_turbo \
  ...
  --prompt "Very slow push in toward the table. The waiter opens his notepad. The awning edge flutters. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 2 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/02.png \
  --prompt "Static shot. HIJO tugs the sleeve twice, then MADRE tilts her chin once. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 3 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/03.png \
  --prompt "Static shot. MADRE leans in slightly and her mouth opens on the word. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 4 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/04.png \
  --prompt "Static shot. MADRE raises two fingers. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 5 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/05.png \
  --prompt "Slight push in. HIJO takes a breath, then his mouth opens wide. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 6 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/06.png \
  --prompt "Slight push in. The waiter lifts the water jug and nods once. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 7 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/07.png \
  --prompt "Static shot. HIJO raises his fists higher. PADRE slowly raises one finger. Background static." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait

# --- SHOT 8 영상 (7.5 cr) ---
higgsfield generate create kling3_0_turbo \
  --start-image frames/08.png \
  --prompt "Static shot. The water glass illustration bobs almost imperceptibly. Nothing else moves." \
  --duration 5 --resolution 1080p --aspect_ratio 9:16 --wait
